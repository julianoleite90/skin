              ...
              O segredo para uma pele mais firme e rejuvenescida, com apenas 15 minutos por dia, você realiza o seu lifting diário e dá adeus as rugas, flacidez e linhas de expressão.
                    ...
                    <div className="flex justify-center md:justify-start pt-4 lg:pt-6">
                      <button 
                        ...
                        className="bg-gradient-to-r from-gray-600 via-gray-700 to-gray-800 hover:from-gray-700 hover:via-gray-800 hover:to-gray-900 text-white font-semibold py-4 px-20 rounded-lg transition-all duration-300 transform hover:scale-105 shadow-lg hover:shadow-xl text-lg"
                      >
                        Ver Depoimentos
                      </button>
                    </div>
